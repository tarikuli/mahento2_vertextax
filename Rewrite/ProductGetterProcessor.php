...
use Vertex\Tax\Model\FlexField\Processor\AttributeRenamer;

/**
 * @inheritDoc
 */
class ProductGetterProcessor implements
    ...
    \Vertex\Tax\Model\FlexField\Processor\TaxCalculationFlexFieldProcessorInterface
{
    ...
    public function getValueFromCreditmemo(
        ...
        return $this->getValueFromProductId($item->getProductId(), $attributeCode, $item->getSku());
    }
    ...
    public function getValueFromQuote(
        ...
        return $this->getValueFromProductId($extAttributes->getProductId(), $attributeCode, $sku);
    }
     ...
     */
    private function getValueFromProductId($productId, $attributeCode, $childSku)
    {
        try {
            $product = $this->productRepository->getById($productId);
            if ($childSku !== null && $product->getTypeId() == "configurable") {
